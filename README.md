...
Initial data extraction from the Parliament's API was done using a Jupyter Notebook script (see `code`). The resulting data was moved to the 'data'. However, a .py script was rendered of this extraction script to allow extraction outside of Notebook environment. 
